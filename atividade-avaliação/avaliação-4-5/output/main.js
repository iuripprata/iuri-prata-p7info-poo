...
//Criar um Cliente 
let cliente = new cliente_1.Cliente(1, "Iuri Pinheiro Prata", 100, "200.345.987-11", tipo_cliente_1.TipoCliente.PESSOA_FISICA);
console.log("=========================");
console.log(cliente);
console.log("=========================");
...
let p1 = new produto_1.Produto(1, 150, "Arroz Prata", 8.00);
let p2 = new produto_1.Produto(2, 200, "Feijão Pau dos Ferros", 7.00);
let p3 = new produto_1.Produto(3, 300, "Preconceito com Farinha", 5.50);
let p4 = new produto_1.Produto(4, 350, "Mucilon Mágico", 8.50);
