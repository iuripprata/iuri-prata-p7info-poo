...
let p1 = new produto_1.Produto(1, 150, "Arroz    Pratinha", 8.00);
let p2 = new produto_1.Produto(2, 200, "Feijão Pau Ferros", 7.00);
let p3 = new produto_1.Produto(3, 300, "Farinha do Sertão", 5.50);
let p4 = new produto_1.Produto(4, 350, "Mucilon do Mágico", 8.50);
